export default function TellerDetail() {
  ...
  const reviews = [
    ...
    },
    {
      ...
      review: "I felt lost after a breakup, but Golf's reading helped me understand what I needed to heal and move forward.",
      rating: 5
    },
    {
      name: "Chalisa P***",
  ...
  return (
    <div className="flex flex-col h-full">
          ...
          <div className="mt-4 flex gap-4">
            ...
            <div className="w-1/2">
              <div className="flex justify-center">
                <p className="bg-purple01/30 flex items-center text-md px-2 w-fit rounded-xl border border-black">Packages</p>
              </div>
        ...
        <div className="mx-4 mb-20 border border-greyborder rounded-t-lg">
          ...
          <div>
            {reviews.map((review, index) => (
              ...
              <div key={index} className="bg-white p-3 border-b-2 border-greyborder">
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-[#2C2D4D] p-4">
        <button className="w-full text-white text-xl font-bold">
          Book
        </button>
      </div>
    </div>
